        ...
        <div className="flex flex-col items-center gap-6">
          <div className="flex items-center gap-6">
            <Link
              ...
              className="text-foreground/80 hover:text-primary transition-colors text-lg font-medium flex items-center gap-2"
            >
          ...
          <p className="text-foreground/60 text-sm text-center font-medium">
