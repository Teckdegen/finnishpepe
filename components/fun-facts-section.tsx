  ...
  return (
    <section className="py-24 px-4 relative">
      <div className="max-w-6xl mx-auto">
        <div className="bg-white rounded-2xl p-8 md:p-12 shadow-2xl border-4 border-amber-300 relative overflow-hidden">
          ...
          <div className="text-center mb-10 relative z-10">
            <h2 className="text-4xl md:text-5xl font-extrabold text-amber-800 text-balance drop-shadow-sm">
              Finnish Fun Facts
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {facts.map((fact, index) => (
              <div 
                key={index}
                className="bg-amber-50 backdrop-blur-sm rounded-lg p-5 shadow-lg border-2 border-amber-200 transform -rotate-1 hover:rotate-0 transition-all duration-300 relative hover:shadow-xl hover:scale-105"
              >
